...
#### 9.25 — Verificar tabla física `projects` y API
...
#### 10.16 — `src/features/business/goals/application/use-cases/get-goal.use-case.ts`

![](images/clipboard-734992670.png)
...
#### 10.23 — Actualizar `src/features/business/business.module.ts`

![](images/clipboard-230759538.png)

#### 10.24 — Actualizar `src/infrastructure/database/seeders/database-seeder.service.ts`

![](images/clipboard-395247862.png)
...
#### 11.23 — Actualizar `src/features/business/business.module.ts`

![](images/clipboard-2012923120.png)

#### 11.24 — Actualizar `src/infrastructure/database/seeders/database-seeder.service.ts`

![](images/clipboard-480608524.png)
...
#### 12.22 — Actualizar `src/infrastructure/database/sequelize/sequelize.factory.ts`

![](images/clipboard-1918510040.png)

#### 12.23 — Actualizar `src/features/business/business.module.ts`

![](images/clipboard-1121074870.png)
...
#### 13.6 — `src/features/business/payment-transactions/infrastructure/persistence/repositories/payment-transaction.repository.ts`

![](images/clipboard-1093233609.png)

#### 13.7 — `src/features/business/payment-transactions/infrastructure/persistence/migrations/create-payment-transactions-table.migration.ts`

![](images/clipboard-3876314950.png)
...
#### 13.17 — `src/features/business/payment-transactions/application/use-cases/get-payment-transaction.use-case.ts`

![](images/clipboard-4118804474.png)
...
#### 13.24 — Actualizar `src/features/business/business.module.ts`

![](images/clipboard-4151748452.png)
...
#### 14.3 — `src/features/business/commissions/domain/interfaces/commission-repository.interface.ts`

![](images/clipboard-3848430488.png)
...
#### 14.14 — `src/features/business/commissions/application/use-cases/update-commission.use-case.ts`

![](images/clipboard-2362967040.png)
...
#### 14.23 — Actualizar `src/features/business/business.module.ts`

![](images/clipboard-1280742634.png)

#### 14.24 — Actualizar `src/infrastructure/database/seeders/database-seeder.service.ts`

![](images/clipboard-2536100616.png)

#### 14.25 — Verificar tabla física `commissions` y API
...
#### 15.14 — `src/features/business/disbursements/application/use-cases/update-disbursement.use-case.ts`

![](images/clipboard-1315807486.png)

#### 15.15 — `src/features/business/disbursements/application/use-cases/delete-disbursement.use-case.ts`

![](images/clipboard-3289056730.png)
...
#### 15.23 — Actualizar `src/features/business/business.module.ts`

![](images/clipboard-1069556894.png)

#### 15.24 — Actualizar `src/infrastructure/database/seeders/database-seeder.service.ts`

![](images/clipboard-1482331041.png)

#### 15.25 — Verificar tabla física `disbursements` y API
...
#### 16.10 — `src/features/business/refunds/application/dto/refund-response.dto.ts`

![](images/clipboard-2395438376.png)
...
#### 16.16 — `src/features/business/refunds/application/use-cases/get-refund.use-case.ts`

![](images/clipboard-681699943.png)

#### 16.17 — `src/features/business/refunds/application/use-cases/list-refunds.use-case.ts`

![](images/clipboard-4175816392.png)
...
#### 17.5 — `src/features/business/project-audits/infrastructure/persistence/repositories/project-audit.repository.ts`
...
#### 17.15 — `src/features/business/project-audits/application/use-cases/delete-project-audit.use-case.ts`

![](images/clipboard-3853816672.png)

#### 17.16 — `src/features/business/project-audits/application/use-cases/get-project-audit.use-case.ts`

![](images/clipboard-1403194465.png)
